...
export function HowItWorksButton() {
  ...
  return (
    <button
      ...
      className="inline-flex size-10 shrink-0 items-center justify-center gap-2 rounded-lg border border-hairline bg-panel text-[13.5px] font-medium text-main transition-colors hover:border-[#d8d2c7] hover:bg-soft focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent sm:h-[34px] sm:w-auto sm:px-3"
    >
